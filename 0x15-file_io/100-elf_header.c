 ...
 *
 * Description: If the provided file doesn't meet the ELF file criteria, 
...
/**
 * print_class - Display the ELF header's class.
...
/**
 * print_os-abi - Display the OS/ABI of an ELF header.
